package br.com.scopus.messenger.core;
...
import br.com.scopus.messenger.core.common.BaseBot;
import br.com.scopus.messenger.core.common.Controller;
import br.com.scopus.messenger.core.common.EventType;
import br.com.scopus.messenger.core.models.Callback;
import br.com.scopus.messenger.core.models.Entry;
...
import br.com.scopus.messenger.core.models.Postback;
import br.com.scopus.messenger.core.models.Response;
import br.com.scopus.messenger.core.models.User;
...
public abstract class Bot extends BaseBot {
     ...
     */
    @GetMapping("/webhook")
    public final ResponseEntity<String> setupWebhookVerification(@RequestParam("hub.mode") String mode,
